...
struct pbProtectionParam {
	...
	string dateToString() const { return ofToString( year ) + "." + ofToString( month ) + "." + ofToString( day ); }
};
...
public:
	...
	string defaultFile() { return "licence.ini"; }
	...
	pbProtectionParam param() { return _param; }
