...
public:
	...
	pbVideoGrabber	&grabber() { return _grabber; }
	void cameraSaveFrame( bool saveRGB, bool saveDepth );		
#endif

	virtual int w() { return 800; }
	virtual int h() { return 600; }
	virtual int frameRate() { return 60; }
	virtual bool cameraGrabberEnabled() { return true; }
	...
	bool debugModeDrawCamera() { return _debugModeDrawCamera == 1; };		
protected:
...
protected:
	int grabW() { return _grabW; }
	int grabH() { return _grabH; }
	int procW() { return _procW; }
	int procH() { return _procH; }
	int flowW() { return _flowW; }
	int flowH() { return _flowH; }
