...
{
	if  ( empty() ) return;			//надо обязательно проверять, вдруг расчеты не прошли!
	//-----------------------
...
{
	if  ( empty() ) return vector<MotionBlob>();			//надо обязательно проверять, вдруг расчеты не прошли!
