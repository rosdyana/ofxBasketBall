...
public:
    ...
    inline float sizeToWorld(float size)
    {
        return size * _invScale;
    }
    inline float sizeToScreen(float size)
    {
        return size * _scale;
    }
    inline float angleToWorld(float angle)
    {
        return - ofDegToRad(angle);
    }
    inline float angleToScreen(float angle)
    {
